...
def extract_features_from_file_event(file_path: str, event_type: str, process_name: str = "",
    ...
    # NOTE: file-system events from watchdog carry no information about
    # which process performed the operation - that requires Sysmon/ETW,
    # not plain filesystem watching. freq_ratio defaults to a low, neutral
    # value here rather than guessing, until process attribution for file
    # events is added in a later milestone.
