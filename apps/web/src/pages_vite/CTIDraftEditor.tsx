...
export default function CTIDraftEditorPage() {
  ...
  const report = ctiReports.find(r => r._id === pageParams.id)
  ...
  if (!report) {
    return (
      <div className="p-6">
        ...
        <button onClick={() => navigate('cti-center')} className="text-sm text-navy-600 mt-2 hover:underline">Back to CTI Center</button>
      </div>
    )
  }
